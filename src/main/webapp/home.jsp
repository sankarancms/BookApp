...
<html>
<head>
<title>CMS Web Store | Home</title>
...
<script type="text/javascript" src="/theme/js/memenu.js"></script>
		...
		<div class="container">
		  ...
		  <div class=" h_menu4">
				<ul class="memenu skyblue">
				    ...
				    <li class="grid"><a class="color2" href="#">	Forum</a>
			...
			<ul class="rslides" id="slider">
			    <li>
						...
						<div class="banner-text">
							<h3>Welcome to CMS Web Store </h3>
							<p></p>
							<p></p>
